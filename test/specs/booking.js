...
describe('End to End flow for booking.com', () => {
    it('User should be able to load the url successfully', async () => {
       ...
       // expect(await homePage.$homePageHeader().isDisplayed()).toBe(true, 'expected home page header to be displayed');
    });
    ...
    it('user should be able to click on Flights button', async() => {
        await homePage.flights();
        expect(await homePage.$flightPageHeader().isDisplayed()).toBe(true,'Expect Flight page header to be displayed');
    });
